          ...
          <div className="w-1/3 max-sm:w-2/3">
            ...
            <form onSubmit={handleSubmit} id="Form">
              ...
              <div className="mt-7">
                <button
                  type="submit"
                  className="rounded-md bg-indigo-700 px-3 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-700 w-full"
                >
                  Send Message
                </button>
              </div>
            ...
            <ul className="flex flex-col gap-8 text-center">
              <li className="flex flex-col gap-5">
                ...
                <p className="text-indigo-700 text-lg font-medium">
                  <a href="tel:+918304873122" target="_blank">
                    +91 8304873122
                  </a>
                </p>
              </li>
              <li className="flex flex-col gap-5">
                ...
                <p className="text-indigo-700 text-lg font-medium">
                  <a href="mailto:vigneshvicky3122@gmail.com" target="_blank">
              ...
              <li className="flex flex-col gap-5">
                ...
                <div className="flex flex-row items-center gap-8">
                  ...
                  <a href="https://github.com/vigneshvicky3122" target="_blank">
